...
public class Excel {
    ...
    public String readExcel(String sheet, int row, int col) throws IOException {
        File f = new File("src/test/resources/testData/InputData.xlsx");
    ...
    public void writeExcel(String sheetName, String value, int col) throws IOException {
        File file = new File("src/test/resources/testData/InputData.xlsx");
...
//        }
        FileOutputStream fileOut = new FileOutputStream("src/test/resources/testData/InputData.xlsx");
        wb.write(fileOut);
    }
