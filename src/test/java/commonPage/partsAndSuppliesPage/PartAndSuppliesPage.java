package commonPage.partsAndSuppliesPage;
...
public class PartAndSuppliesPage extends BasePage {
    ...
    public PartAndSuppliesPage(WebDriver driver) {
        super(driver);
    }

    public PartAndSuppliesPage clickOnNavigationMenuContainer() {
        fluentWait(navigation);
        moveToElementAndForceClick(navigation);
        return this;
    }

    public PartAndSuppliesPage SelectPrimaryCatalog(String catalog) {
    ...
    public PartAndSuppliesPage SelectSubCatalog(String subCatalog) {
    ...
    public PartAndSuppliesPage clickOnAirCompressors(String subCatalog, int index) {
        scrollToTheBottom();
    ...
    public PartAndSuppliesPage getProductDetails(String index) throws IOException {
    ...
    public PartAndSuppliesPage clickOnCompressor(String index) {
